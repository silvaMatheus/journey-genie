    ...
    <>
      <form onSubmit={handleSubmit} className="space-y-4 p-4 border rounded-lg bg-white">
        ...
        <div>
          ...
          <DatePicker
            selected={formData.workDays.length ? formData.workDays : null}
            onChange={handleWorkDaysChange}
            startDate={formData.workDays.length ? formData.workDays[0] : null}
            endDate={formData.workDays.length ? formData.workDays[formData.workDays.length - 1] : null}
            selectsRange
            inline
          />
        </div>
